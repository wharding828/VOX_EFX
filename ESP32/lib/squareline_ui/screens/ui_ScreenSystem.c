...
void ui_ScreenSystem_screen_init(void)
{
    ...
    lv_obj_set_style_pad_left(ui_lblDevName, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_lblDevName, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_left(ui_lblBrokerName, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_lblBrokerName, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
